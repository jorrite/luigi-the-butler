...
const programMessage = " Maar natuurlijk!\n\n<!channel>, waarde gasten, het is mij een genoegen u het programma voor het huwelijksweekend te presenteren. U kunt deze bekijken door <"+functions.config().links.program+"|hier te klikken>. De festiviteiten beginnen op zaterdag 19 mei, tot dan!";
